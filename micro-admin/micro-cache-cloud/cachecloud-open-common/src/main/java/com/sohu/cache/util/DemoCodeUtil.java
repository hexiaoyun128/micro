...
public class DemoCodeUtil {
    ...
    static {
        ...
        redisSentinelSpring.add("&lt;bean id=\"redisSentinelFactory\" class=\"com.hechihan.micro.mobil.common.data.RedisSentinelFactory\" init-method=\"init\"&gt;");
        ...
        redisSentinelSpring.add("import com.hechihan.micro.builder.ClientBuilder;");
        ...
        redisClusterSpring.add("import com.hechihan.micro.builder.ClientBuilder;");
    ...
    public static List<String> getDependencyRedis() {
        ...
        dependencyRedis.add("&nbsp;&nbsp;&nbsp;&nbsp;&lt;groupId&gt;com.hechihan.micro&lt;/groupId&gt;                                   ");
